...
def prepare_selected_features(
    ...
    """
    Prepare RF-H input using preprocessing values
...
def scam_probability(
    ...
    if not hasattr(
        ...
        raise ValueError(
            "RF-H model has not been fitted."
        )
...
def evaluate_validation(
    ...
    # Validation should contain both classes,
    # but keep the calculation defensive.
    try:
